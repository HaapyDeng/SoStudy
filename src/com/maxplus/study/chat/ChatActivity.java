...
public class ChatActivity extends BaseActivity {
    ...
    private void initReceiver() {
        ...
        filter.addAction(AppApplication.UPDATE_GROUP_NAME_ACTION);
        ...
        public void onReceive(Context context, Intent data) {
            if (data != null) {
                ...
                if (data.getAction().equals(
                		AppApplication.UPDATE_GROUP_NAME_ACTION)) {
    ...
    public void handleMsg(android.os.Message msg) {
        switch (msg.what) {
            case AppApplication.UPDATE_CHAT_LIST_VIEW:
                mChatController.getAdapter().refresh();
                break;
            case AppApplication.REFRESH_GROUP_NAME:
                ...
                break;
            case AppApplication.REFRESH_GROUP_NUM:
                int num = msg.getData().getInt("membersCount");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == AppApplication.REQUESTCODE_TAKE_PHOTO) {
...
//        startActivity(intent);
    ...
    public void onEvent(ConversationRefreshEvent conversationRefreshEvent) {
        mHandler.sendEmptyMessage(AppApplication.REFRESH_GROUP_NAME);
    }
    ...
    public void onEvent(MessageEvent event) {
        ...
        //刷新消息
        mHandler.sendEmptyMessage(AppApplication.UPDATE_CHAT_LIST_VIEW);
    }
            ...
            public void gotResult(int status, String desc, GroupInfo groupInfo) {
                if (status == 0) {
                    if (!TextUtils.isEmpty(groupInfo.getGroupName())) {
                        ...
                        handleMessage.what = AppApplication.REFRESH_GROUP_NAME;
                        ...
                        android.os.Message handleMessage = mHandler.obtainMessage();
                        handleMessage.what = AppApplication.REFRESH_GROUP_NUM;
                        Bundle bundle = new Bundle();
                        bundle.putInt("membersCount", groupInfo.getGroupMembers().size());
                        handleMessage.setData(bundle);
                        handleMessage.sendToTarget();
